...
public final class SystemBridge {
    ...
    private static BridgeResult healthCheck() {
        ...
        data.put("debugBridgeEnabled", PzRuntimeConfig.isDebugBridgeEnabled());
        data.put("hasDebugSelfTestNow", ModuleRegistry.has("pz.bridge.debug.selfTestNow"));
        data.put("hasDebugClaimNode", ModuleRegistry.has("pz.bridge.debug.claimNode"));
        data.put("hasDebugGrantPermissionToSelf", ModuleRegistry.has("pz.bridge.debug.grantPermissionToSelf"));
        data.put("hasDebugAssignRoleToSelf", ModuleRegistry.has("pz.bridge.debug.assignRoleToSelf"));
